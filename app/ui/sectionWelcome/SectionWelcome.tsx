...
export default function SectionWelcome(){
    return(
        <section id="welcome" className={`${style.sectionHome}  scroll-pt-[-80px] mt-[80px] h-auto p-6`}>
            <article className="text-center flex flex-col justify-center items-center gap-[1vh]">
                ...
                className="text-slate-50 dark:text-slate-50 bg-[#00a388] px-6 py-2 rounded-full inline-block my-6 mx-auto"
                target="_blank"
                >
                        Download my CV!
                </Link>
